    ...
    switchMap((action) =>
      from(apis.specialties.loadSpecialties(action.payload)).pipe(
        ...
        catchError((restException: RestException) =>
          of(loadSpecialtiesAsync.failure(restException)),
        ),
      ),
    ),
  )
  ...
  action$.pipe(
    ...
    switchMap((action) =>
      from(apis.specialties.loadSpecialties(action.payload)).pipe(
        ...
        catchError((restException: RestException) =>
          of(appendSpecialtiesAsync.failure(restException)),
        ),
      ),
    ),
  )
  ...
  action$.pipe(
    ...
    switchMap((action) =>
      from(apis.specialties.loadSpecialty(action.payload)).pipe(
        ...
        catchError((restException: RestException) =>
          of(loadSpecialtyAsync.failure(restException)),
        ),
      ),
    ),
  )

export const loadTranslatedSpecialtyEpic: RootEpic = (
  action$,
  state$,
  { apis },
) =>
  action$.pipe(
    ...
    switchMap((action) =>
      from(apis.specialties.loadSpecialty(action.payload)).pipe(
        ...
        catchError((restException: RestException) =>
          of(loadTranslatedSpecialtyAsync.failure(restException)),
        ),
      ),
    ),
  )
